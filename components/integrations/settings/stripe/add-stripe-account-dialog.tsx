...
export function AddStripeAccountDialog({
  open,
  onOpenChange,
  onConfirm,
  mode = "add",
  ...
  const title =
    mode === "edit"
      ? "Edit Stripe account display name"
      : "Add new Stripe account"

  const submitLabel = mode === "edit" ? "Done" : "Add account"
        ...
        >
          <div className="flex w-full items-center gap-2 px-4 pt-4">
            ...
            <DialogPrimitive.Description className="sr-only">
              Name this Stripe account, then continue to connect it.
