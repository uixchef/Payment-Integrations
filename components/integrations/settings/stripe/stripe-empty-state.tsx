    ...
    <div className="flex w-full flex-col items-center gap-4 py-8 text-center">
      ...
      <div className="flex max-w-[560px] flex-col items-center gap-1">
        ...
        <p className="font-[family-name:var(--font-inter)] text-base leading-6 text-[#475467]">
          Stripe supports 125+ payment methods, including cards, digital
          wallets, bank debits, bank redirects, buy now pay later options,
          vouchers, and real time payments.
        </p>
      </div>
