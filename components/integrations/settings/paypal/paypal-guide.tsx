...
const PAYPAL_DOCS_HREF =
  "https://help.gohighlevel.com/support/solutions/articles/48000980322-paypal-integration"
...
export function PayPalGuide({ isConnected }: { isConnected: boolean }) {
  ...
  return (
    ...
    >
      ...
      <Button asChild variant="neutral" className="w-full px-2">
        <a href={PAYPAL_DOCS_HREF} target="_blank" rel="noreferrer noopener">
          View documentation
        </a>
      </Button>
    </aside>
