...
function NavRow({
  ...
  return (
    <Link
      ...
      className={cn(
        "flex w-full items-center gap-2 rounded-lg text-base font-medium leading-6 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30",
        ...
        >
          ...
          >
            ...
            {collapsed ? (
              <button
                type="button"
                className="flex w-full max-w-[40px] items-center justify-center rounded-lg bg-[#344054] p-2 hover:bg-[#344054]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
              ...
              <button
                type="button"
                className="flex w-full items-center gap-2 rounded-lg bg-[#344054] p-2 text-left text-sm font-medium text-white/90 hover:bg-[#344054]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
              >
          ...
          {collapsed ? (
            <div className="flex w-full flex-col gap-2">
              <button
                type="button"
                className="flex w-full items-center justify-center rounded-lg border border-[#344054] p-1 hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
                aria-label="Search"
              >
                <Image
              ...
              <button
                type="button"
                className="flex w-full items-center justify-center rounded-lg bg-[#344054] px-[11px] py-1.5 hover:bg-[#3d4a5f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
            ...
            <div className="flex shrink-0 gap-2">
              ...
              <button
                type="button"
                className="flex shrink-0 items-center justify-center rounded-lg bg-[#344054] px-[11px] py-1.5 hover:bg-[#3d4a5f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
                aria-label="Quick actions"
              >
                <Image
                  src={`${ICON}/icon_quickact.svg`}
